...
class Purple : FrameFilter {
    
    var description: String = "Purple (Metal)"
    ...
    required init() {
        ...
        let kernelFunction = defaultLibrary.makeFunction(name: "purple")
        do {
    ...
    func render(pixelBuffer: CVPixelBuffer) -> CVPixelBuffer? {
        ...
        commandEncoder.label = "Purple Metal"
